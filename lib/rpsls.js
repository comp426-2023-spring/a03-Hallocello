//First, we need to make this function callable from outside this file.

//This first function will work for rock paper scissors only and throw an error for rpsls
export function rps_function(player_attack){
...
export function rpsls_function(player_attack) {
	...
	(player_attack === 'paper' && (opponent_attack === 'rock' || opponent_attack === "spock")) ||
      ...
      return `You chose ${shot}, while the enemy chose ${opponent}. ${message}`;
    } 
